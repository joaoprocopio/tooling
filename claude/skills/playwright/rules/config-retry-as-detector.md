...
- Shopify: tests individually 99.95% reliable produced a pipeline that passed 35% of the time, because suite reliability is the _product_ of individual reliabilities. Flakiness compounds, and surfacing every pass-on-retry is the countermeasure.
